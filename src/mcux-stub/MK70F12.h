// _JUST_ enough of a device header for the USB peripheral to work.
// You'll have to provide clocks and the rest of the board support yourself somewhere...
// Copied from MK64, with IRQ number updated...
// NOTE: NO support for the USB-HS periph on K70, which requires an external phy due to errata.
typedef enum IRQn
{
